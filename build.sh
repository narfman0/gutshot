...
if [[ "${1:-}" == "test" ]]; then
	echo "== tests"
	for t in resources_smoke combat_smoke ai_probe district_world_smoke district_combat_smoke district_respawn_smoke district_pursuit_smoke district_progression_smoke district_corp_smoke district_horde_smoke; do
		echo "-- $t"
