...
func _build_market_dressing() -> void:
	...
	# Bays between the stalls — duck into a shopfront when the alley opens up.
	add_bay(Vector3(-10.4, 0, 20.0), 3.6, 90.0, Color(0.21, 0.16, 0.14), Color(1.0, 0.4, 0.45))
	add_bay(Vector3(10.4, 0, -16.0), 3.6, 270.0, Color(0.21, 0.16, 0.14), Color(0.35, 0.9, 1.0))
